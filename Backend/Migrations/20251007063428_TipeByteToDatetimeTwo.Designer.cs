...
namespace Backend.Migrations
{
    ...
    [Migration("20251007063428_TipeByteToDatetimeTwo")]
    partial class TipeByteToDatetimeTwo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.PaymentDetailModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Backend.Models.PaymentDetailModel", b =>
                {
                    b.HasOne("Backend.Models.CheckoutModel", "Checkout")
                        .WithMany("PaymentDetails")
                        .HasForeignKey("IdCheckout")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Backend.Models.PaymentModel", "Payment")
                        .WithMany("PaymentDetails")
